...
abstract class Content
{
    ...
    {
        $data = sprintf('<meta http-equiv="content-type" content="text/html;charset=utf-8"><base href="%s"><div>%s', htmlspecialchars($escaped_node->baseURI, ENT_QUOTES, 'UTF-8'), $escaped_node->textContent);
